        ...
        <div className={styles.contentWrapper}>
          ...
          <section className={styles.storytelling}>
            <p className="font-size-xl">
              I design and develop full-stack products for the web, utilizing the JavaScript
              ecosystem to create efficient and intuitive ways to interact with data in a browser.
            </p>
            <p className="font-size-xl">
